      ...
      <div className="content-inner">
        <div className="panel">
          ...
          <div className="panel-body">
            <Table rowKey="id" bordered columns={columns} dataSource={this.state.data.room} pagination={false} loading={this.state.loading} scroll={{ x: 1800  }} />
          </div>
        </div>
      </div>
    )
