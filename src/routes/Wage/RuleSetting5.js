...
class RuleSetting5 extends React.Component {
  ...
  componentDidMount = () => {
    ax.get(`/stores/${this.sid}/wages/rules/5`).then(d => {
      if (d.seniority != null) {
  ...
  handleSubmit = (e) => {
    ...
    this.props.form.validateFields((err, values) => {
      if (!err) {
        ...
        ax.patch(`/stores/${this.sid}/wages/rules/5`, values)
      }
    })
  }
...
export default Form.create()(RuleSetting5)