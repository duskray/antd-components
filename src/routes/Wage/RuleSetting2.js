...
class RuleSetting2 extends React.Component {
  ...
  componentDidMount = () => {
    ax.get(`/stores/${this.sid}/wages/rules/2`).then(d => {
      if (d.seniority != null) {
  ...
  handleSubmit = (e) => {
    ...
    this.props.form.validateFields((err, values) => {
      if (!err) {
        ...
        ax.patch(`/stores/${this.sid}/wages/rules/2`, values)
      }
    });
  }
        ...
        <div className="panel">
          ...
          <div className="panel-body">
            <Form onSubmit={this.handleSubmit}>
              ...
              <hr />
              <Item {...formItemLayout} label="待客提成" >
                <Row>
                  <Col span={12}>
                    日均待客数
                  </Col>
              ...
              <Item {...formItemLayout} label="评价奖励">
                <span style={{marginRight:'8px'}}>五星好评单客提成奖励</span>
...
export default Form.create()(RuleSetting2)