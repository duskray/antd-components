...
class RuleSetting4 extends React.Component {
  ...
  componentDidMount = () => {
    ax.get(`/stores/${this.sid}/wages/rules/4`).then(d => {
      if (d.seniority != null) {
  ...
  handleSubmit = (e) => {
    ...
    this.props.form.validateFields((err, values) => {
      if (!err) {
        ...
        ax.patch(`/stores/${this.sid}/wages/rules/4`, values)
      }
    })
  }
        ...
        <div className="panel">
          ...
          <div className="panel-body">
            <Form onSubmit={this.handleSubmit}>
              ...
              <hr />
              <Item {...formItemLayout} label="客流提成" >
                <Row>
                  <Col span={12}>
                    日均客流数
                  </Col>
...
export default Form.create()(RuleSetting4)